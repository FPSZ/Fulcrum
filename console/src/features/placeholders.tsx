...
export const policiesModule = defineFeature({
  id: 'policies', label: '策略中心', icon: Scale, group: '管控', order: 30, requires: 'policies.view', component: ph('策略中心'),
})
...
export const auditModule = defineFeature({
  id: 'audit', label: '审计溯源', icon: FileSearch, group: '取证', order: 60, requires: 'audit.view', component: ph('审计溯源'),
})
export const evalModule = defineFeature({
  id: 'eval', label: '评测验证', icon: FlaskConical, group: '取证', order: 70, requires: 'eval.view', component: ph('评测验证'),
})
