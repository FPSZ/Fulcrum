...
> 整体落地进度见 [03-进度看板](03-进度看板.md)。
> 当前对账（2026-08-31）：本文是历史 M1 计划；已落地能力和未合并 PR 不以本计划中的目标描述替代，详见 [`03-进度看板.md`](03-进度看板.md) 与 [`../review/01-开放PR状态与合并门槛.md`](../review/01-开放PR状态与合并门槛.md)。
